    ...
    <div>
      ...
      <section className="bg-blue-100 w-screen -ml-10 p-8 md:p-16">
        ...
        <p className="text-justify text-sm md:text-base lg:text-lg xl:text-xl">
          Titans Tech-IT understands your need to get your ideal recruiter,
          which coordinates with your plans and skill sets. To save you from the
          heavy charges of consultancies, we have been providing Canada IT
          staffing services for the past decades, so we have got the hang of
          what candidates are looking for; this helps us provide you with our
          service in a tailored way so that you can experience our uniqueness.
          For freshers, we also provide ideal trainers so they can develop along
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:mx-10">
          <div className="text-justify my-5 md:mx-5">
            <div className="space-y-4 pt-6 text-[13px] md:text-[16px]">
              <p>
                At Titans, we have such team of tech experts who have gained
      ...
      <ValueCard
        title={"WHY CHOOSE TITANS TECH-IT AS YOUR"}
